...
export default function TextEditor({initContent, eRoute, setIsLoading} : {initContent: string, eRoute: string, setIsLoading: React.Dispatch<React.SetStateAction<boolean>>}) {
        ...
        <Editor 
          ...
          init={{ 
            ...
            save_onsavecallback: (): void => {
              save(setContent, editorRef, eRoute, setIsLoading)
            }
          }}
        />
        </form>
